...
Article Search is an android app that allows a user to search for images on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
<img src='https://github.com/larryshijiawei/ArticleSearch/blob/master/demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
